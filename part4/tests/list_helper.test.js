...
describe('favorite blog', () => {
  ...
  test('when list has only one blog equal the only blog', () => {
    const result = listHelper.favoriteBlog(listWithOneBlog)
    expect(result).toEqual(listWithOneBlog[0])
  })

  test('when list has multiple blogs equals most liked one', () => {
    const result = listHelper.favoriteBlog(listWithMultipleBlogs)
    expect(result).toEqual(listWithMultipleBlogs[2])
  })
})

describe('who writes most blogs', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('when list has multiple blogs the auther that writes most', () => {
    const result = listHelper.mostBlogs(listWithMultipleBlogs)
    expect(result).toEqual({name: 'Robert C. Martin', blogs: 3})
  })
})

describe('whose blogs get most likes', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('when list has multiple blogs the auther that liked most', () => {
